...
app.post("/create_employee", function (req, res) {
	...
	var data = 
		...
		var config = {
			method: 'post',
			url: 'https://spalabproject2-default-rtdb.firebaseio.com/data.json',
			headers: { 
...
app.get("/directory", function (req, res) {
	...
	var config = {
	method: 'get',
	url: 'https://spalabproject2-default-rtdb.firebaseio.com/.json',
	headers: { }
	};
...
app.get("/directory/:uid", function (req, res) {
 let id = req.params.uid;
	...
	var config = {
		method: 'get',
		url: `https://spalabproject2-default-rtdb.firebaseio.com/data/${id}.json`,
		headers: { }
	  };
...
////https://spalabproject2-default-rtdb.firebaseio.com/
////https://spa-lab-ii-default-rtdb.firebaseio.com/	